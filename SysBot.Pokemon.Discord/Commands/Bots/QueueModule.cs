...
public class QueueModule<T> : ModuleBase<SocketCommandContext> where T : PKM, new()
{
    ...
    [Summary("Discord ID or mention of the user (optional)")] string targetUserIdOrMention = null, [Summary("New 8-digit trade code")] string newCode = null)
    {
                    ...
                    if (targetUser != null)
                    {
                        try
                        {
                            var embed = new EmbedBuilder()
                                ...
                                .WithThumbnailUrl("https://raw.githubusercontent.com/Cyb3r8/Bot-Images/refs/heads/main/Ninetales%20Paradise/UpdateTradeCode.png")
                                .Build();
