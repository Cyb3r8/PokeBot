...
public class PokeDataOffsetsPLZA
{
    ...
    public IReadOnlyList<long> GameStatePointer { get; } = [0x5F58600, 0x58];
    ...
    public IReadOnlyList<long> Trader1MyStatusPointer { get; } = [0x3EFD058, 0x1D8, 0x180, 0x80, 0x74];
    ...
    public IReadOnlyList<long> TradeBoxStatusPointer { get; } = [0x41FD140, 0x108];

    // ✅ VERIFIED - Trade partner offered Pokemon data
